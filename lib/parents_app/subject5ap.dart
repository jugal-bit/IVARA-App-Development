...
class subject5acap extends StatefulWidget{
  @override

  _Subject5acapState  createState() => _Subject5acapState();

}

class _Subject5acapState extends State<subject5acap> {
  @override
            ...
            child: Container(
              child: Align(
                ...
                child: Padding(
                  ...
                  child: Text('Geography', style: TextStyle(color: Colors.white,fontSize: 50.0,fontWeight: FontWeight.bold),),
                ),
              ),
            ),
          ),
