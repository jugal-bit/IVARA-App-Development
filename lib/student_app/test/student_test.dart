        ...
        child: Column(
          ...
          children: <Widget>[
                    ...
                    child: Padding(
                      ...
                      child: Container(
                          ...
                          child: Row(
                            children: <Widget>[
                              Padding(
                                padding: EdgeInsets.fromLTRB(31, 1, 5, 1),
                                child: Text(
                                  "Quizzes",
                                  style: TextStyle(fontSize: 20),
                                ),
                    ...
                    child: Padding(
                      ...
                      child: Container(
                          ...
                          child: Row(
                            children: <Widget>[
                              Padding(
                                padding: EdgeInsets.fromLTRB(40, 1, 5, 1),
                                child: Text(
                                  "PYQs",
                                  style: TextStyle(fontSize: 20),
                                ),
            ...
            Padding(
              ...
              child: Conditioned(
                cases: [
                  Case(mock == 'Test', builder: () => Column(
                children: testSeries
                    .map((TestSeries) => testseriesTemplate(TestSeries))
                    .toList(),
              ), ),
                  Case(mock == 'Quiz', builder: () => Column(
                children: quizSeries
                    .map((QuizSeries) => quizseriesTemplate(QuizSeries))
                    .toList(),
              ), ),
                  Case(mock == 'PYQ', builder: () => Column(
                children: pyqSeries
                    .map((PYQSeries) => pyqseriesTemplate(PYQSeries))
                    .toList(),
              ), ),
                ],
