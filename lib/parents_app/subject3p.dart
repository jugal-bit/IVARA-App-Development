...
class subject3p extends StatefulWidget{
  @override

  _Subject3atpState  createState() => _Subject3atpState();

}

class _Subject3atpState extends State<subject3p> {
            ...
            child: Container(
              child: Align(
                ...
                child: Padding(
                  ...
                  child: Text('Chemistry', style: TextStyle(color: Colors.black,fontSize: 70.0,fontWeight: FontWeight.bold),),
                ),
              ),
            ),
          ),
