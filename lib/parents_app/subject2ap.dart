...
class subject2acap extends StatefulWidget{
  @override

  _Subject2acapState  createState() => _Subject2acapState();

}

class _Subject2acapState extends State<subject2acap> {
  @override
            ...
            child: Container(
              child: Align(
                ...
                child: Padding(
                  ...
                  child: Text('Physics', style: TextStyle(color: Colors.white,fontSize: 50.0,fontWeight: FontWeight.bold),),
                ),
              ),
            ),
          ),
